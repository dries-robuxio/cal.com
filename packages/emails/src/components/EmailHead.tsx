...
const EmailHead = ({ title = "" }) => {
  return (
    <head>
      ...
      />
      <RawHtml
        html={`<!--[if !mso]><!--><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&display=swap" rel="stylesheet" type="text/css"/>
      <style type="text/css">@import url(https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&display=swap);</style><!--<![endif]-->`}
      />
      <style type="text/css">
        {`
